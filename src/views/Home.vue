        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde el ámbito educativo, comprender el contexto institucional es fundamental para analizar cómo las instituciones influyen en la formación de la primera infancia. En esta unidad, se explorará la estructura organizativa, pedagógica y normativa de los centros educativos, mediante la observación y el análisis de documentos institucionales.

              p.descripcion.mb-4 A lo largo del proceso, se profundizará en la importancia del Proyecto Educativo Institucional (PEI), los proyectos transversales y la normatividad vigente, elementos clave que permiten articular la teoría con la práctica pedagógica. Además, se fomentará una reflexión crítica sobre la relación entre la planificación educativa y la realidad institucional, con el objetivo de fortalecer las estrategias de enseñanza y mejorar el desarrollo infantil.
              
              p #[b ¡Prepárese para analizar y transformar el entorno educativo con una visión reflexiva y fundamentada!]
